...
writes a JSONL run history + summary. It never deploys and opens no PRs unless
explicitly opted in per phase. "Shape only": no DAG, no data-passing between
phases, no new gate logic.
"""
